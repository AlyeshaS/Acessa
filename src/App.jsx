      ...
      <div className="home-page">
        ...
        <div className="hero-section">
          ...
          <h1 className="hero-title">
            Make the web <span className="hero-accent">accessible</span><br />for everyone.
          </h1>
          <p className="hero-subtitle">Paste any URL and get an instant WCAG 2.2 score, HCI report, and actionable fixes.</p>
          ...
          <div className="feature-grid">
            ...
            <div className="feature-card feature-card--score">
              <div className="feature-illustration" aria-hidden="true">
                <div className="feature-icon-bg feature-icon-bg--score">
                  <svg fill="currentColor" viewBox="0 0 92 92" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="feature-body">
                ...
                <p className="feature-desc">Instant compliance score across all four POUR principles — Perceivable, Operable, Understandable, Robust.</p>
              </div>
            </div>
            ...
            <div className="feature-card feature-card--hci">
              ...
              <div className="feature-body">
                ...
                <p className="feature-desc">A detailed human-computer interaction analysis covering cognitive load, usability patterns, and mobile experience.</p>
              </div>
            </div>
            ...
            <div className="feature-card feature-card--steps">
              ...
              <div className="feature-body">
                ...
                <p className="feature-desc">Prioritised, actionable recommendations to fix every issue — with specific WCAG criteria and code-level guidance.</p>
              </div>
            </div>
